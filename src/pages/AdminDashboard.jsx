  ...
  return  (
   ...
   <div className="flex">
      ...
      <div className="flex-1 p-6 ml-60">
        {activeTab === "dashboard" && <h2 className="text-5xl mb-4 font-bold text-center ">Dashboard</h2>}
        <div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center justify-center text-center border border-gray-200 hover:shadow-xl transition-all">
       ...
       <div className="bg-white p-6 rounded-2xl shadow-lg flex flex-col items-center justify-center text-center border border-gray-200 hover:shadow-xl transition-all">
        ...
        {activeTab === "users" && (
          <div>
            <h3 className="text-4xl font-semibold text-gray-800 mb-4 text-center">All Users</h3>
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-b hover:bg-gray-100">
                   ...
                   {user?.profile_picture ? (
                     <>
                       <img
                         ...
                         alt="Profile"
                         onError={(e) => {
                           if (e.target.src !== "http://localhost:5000/uploads/default-profile.png") {
                  ...
                  <td className="border p-3">{editUserId === user.id ? <input type="text" name="name" value={editUserData.name} onChange={handleInputChange} onBlur={handleUpdateUser} className="border p-2 rounded w-full" /> : user.name}</td>
                  <td className="border p-3">{editUserId === user.id ? <input type="email" name="email" value={editUserData.email} onChange={handleInputChange} onBlur={handleUpdateUser} className="border p-2 rounded w-full" /> : user.email}</td>
                  <td className="border p-3">{editUserId === user.id ? <select name="role" value={editUserData.role} onChange={handleInputChange} onBlur={handleUpdateUser} className="border p-2 rounded w-full"><option value="admin">Admin</option><option value="manager">Manager</option><option value="member">Member</option></select> : user.role}</td>
                  <td className="border p-3">{editUserId === user.id ? <select name="status" value={editUserData.status} onChange={handleInputChange} onBlur={handleUpdateUser} className="border p-2 rounded w-full"><option value="active">Active</option></select> : user.status}</td>
                  <td className=" p-6 flex items-center gap-2">
                  {editUserId === user.id ? (
  <button className="bg-green-500 text-white px-3 py-1 rounded-md hover:bg-green-600" onClick={handleUpdateUser}>
    ✅ Save
  </button>
) : (
  <button className="bg-blue-500 text-white px-3 py-1 rounded-md hover:bg-blue-600 cursor-pointer" onClick={() => handleEditClick(user)}>
    <FaEdit className="inline-block mr-1" /> Edit
  </button>
)}
<button className="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600 cursor-pointer" onClick={() => handleDeleteUser(user.id)}>
  <FaTrash className="inline-block mr-1" /> Delete
        ...
        {activeTab === "projects" && (
          <div>
            <h3 className="text-4xl font-semibold mb-4 text-center">All Projects</h3>
            <table className="w-full border-collapse border border-gray-300">
              <thead>
                <tr className="bg-gray-200">
